...
knitr::purl('environment 2.Rmd', documentation = 0)
```

```{r echo=FALSE, purl=F}
xfun::embed_file('environment 2.Rmd')
```

```{r echo=FALSE, purl=F}
xfun::embed_file('environment 2.R')
```
...
Practice 1.3 - Lauriane 09/19/2022 for practice 1.3 again
